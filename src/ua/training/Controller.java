...
import static ua.training.MultiLang.Regex.*;
...
abstract class Input {
    ...
    abstract void updateModel(Model model, View view, String userInput);
    ...
    public void processUserInput(Model model, View view, Scanner scanner) {
        ...
        String userInput = getCorrectInput(view, scanner);
        updateModel(model, view, userInput);
    }
    ...
    private String getCorrectInput(View view, Scanner scanner) {
        String userInput;
        while(true) {
...
class InputLogin extends Input {
    ...
    @Override
    void updateModel(Model model, View view, String userInput) {
        try {
...
class Controller {
    ...
    /**
     * Constructs controller instance
